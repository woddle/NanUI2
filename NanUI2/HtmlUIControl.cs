...
namespace NanUI2
{
    ...
    public partial class HtmlUIControl : UserControl, IChromiumWebBrowser
    {
		...
		public HtmlUIControl() : this(null)
		{
            InitProperty();
		}

        public HtmlUIControl(string initialUrl, bool forceNonclientMode = false)
		{
            InitProperty();
